...
// ========== ДОБАВИТЬ ЭТОТ БЛОК ==========
// Специальная обработка для Scorpion — восстановление HP
if (skillResult.triggered && skillResult.skillId === 'venom_strike') {
    // Восстанавливаем 10% HP атакующему
    const healAmount = Math.floor(attacker.maxHp * 0.10);
    attacker.currentHp = Math.min(attacker.maxHp, attacker.currentHp + healAmount);
    // Добавляем в лог
    if (!skillResult.healAmount) skillResult.healAmount = healAmount;
}
// ==========================================
